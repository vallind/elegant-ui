...
/** Maps Monet color roles to ELYON color scheme.
 *
 ...
 * @return The mapped ELYON [Colors].
 */
internal fun mapMd3RolesToElyonColorsCommon(roles: MonetRoles, dark: Boolean): Colors {
