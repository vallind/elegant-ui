        ...
        Column(
            ...
            title?.let {
                Text(
                    ...
                    text = it,
                    fontSize = ElyonTheme.textStyles.title4.fontSize,
...
object DialogDefaults {
     ...
     */
    @Composable
    fun titleColor() = ElyonTheme.colorScheme.onBackground

    /**
     * The default color of the summary.
     */
    @Composable
    fun summaryColor() = ElyonTheme.colorScheme.onSurfaceSecondary

    /**
     * The default background color of the dialog.
     */
    @Composable
    fun backgroundColor() = ElyonTheme.colorScheme.background
