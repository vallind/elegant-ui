...
/**
 * A [TopAppBar] with Elyon style that can collapse and expand based on the
...
fun TopAppBar(
    ...
    titleColor: Color = ElyonTheme.colorScheme.onSurface,
    largeTitle: String = title,
    largeTitleColor: Color = ElyonTheme.colorScheme.onSurface,
    subtitle: String = "",
    subtitleColor: Color = ElyonTheme.colorScheme.onSurfaceVariantSummary,
...
/**
 * A [SmallTopAppBar] with Elyon style.
 *
    ...
    Layout(
        {
            ...
            Box(
                ...
                Text(
                    ...
                    fontSize = ElyonTheme.textStyles.title3.fontSize,
            ...
            Box(
                ...
                Column(
                    ...
                    Text(
                        ...
                        fontSize = ElyonTheme.textStyles.title1.fontSize,
