 ...
 *
 * This implements the basic elyon design visual layout structure.
 *
 ...
 * be show, typically a [ElyonPopupHost].
...
fun Scaffold(
    ...
    popupHost: @Composable () -> Unit = { ElyonPopupHost() },
    containerColor: Color = ElyonTheme.colorScheme.surface,
    contentWindowInsets: WindowInsets = WindowInsets.systemBars.union(WindowInsets.displayCutout),
    content: @Composable (PaddingValues) -> Unit,
) {
    val safeInsets = remember(contentWindowInsets) { MutableWindowInsets(contentWindowInsets) }
    val popupStates = remember { mutableStateListOf<ElyonPopupUtils.PopupState>() }
    val dialogStates = remember { mutableStateListOf<ElyonPopupUtils.DialogState>() }
 ...
 * @param popup the [ElyonPopupHost] displayed on top of the [content].
