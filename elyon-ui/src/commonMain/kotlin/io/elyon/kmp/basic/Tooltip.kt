...
/**
 * Elyon's tooltip primitive. Forked from the experimental foundation `BasicTooltipBox` so the mouse
...
/**
 * A plain tooltip that briefly describes an anchor with a short text label, using the Elyon inverse
 * surface style.
 *
 ...
 * [action], using the Elyon surface-container card style.
 *
 * @param modifier the modifier applied to the tooltip.
...
object TooltipDefaults {
    ...
    val plainTooltipContainerColor: Color
        @Composable get() = ElyonTheme.colorScheme.onSecondaryVariant

    /** The default content color of a plain tooltip. */
    val plainTooltipContentColor: Color
        @Composable get() = ElyonTheme.colorScheme.secondaryVariant
    ...
    /** Returns a [Shape] that, when passed as `caretShape`, enables the Elyon tooltip caret. */
    fun caretShape(): Shape = TooltipCaretShape

    @Composable
    fun richTooltipColors(
        containerColor: Color = ElyonTheme.colorScheme.surfaceContainer,
        contentColor: Color = ElyonTheme.colorScheme.onSurfaceContainerVariant,
        titleContentColor: Color = ElyonTheme.colorScheme.onSurfaceContainer,
        actionContentColor: Color = ElyonTheme.colorScheme.primary,
