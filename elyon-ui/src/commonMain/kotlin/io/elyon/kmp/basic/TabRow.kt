...
/**
 * A [TabRowWithContour] with Elyon style.
 *
 * @param tabs The text to be displayed in the [TabRow].
 * @param selectedTabIndex The selected tab index of the [TabRow].
 * @param onTabSelected The callback when a tab is selected.
...
private fun TabItem(
    ...
    val outlineColor = ElyonTheme.colorScheme.outline
    Box(
        modifier = Modifier
            .fillMaxHeight()
            .width(width)
...
object TabRowDefaults {
    ...
    @Composable
    fun tabRowColors(
        backgroundColor: Color = ElyonTheme.colorScheme.surface,
        contentColor: Color = ElyonTheme.colorScheme.onSurfaceVariantSummary,
        selectedBackgroundColor: Color = ElyonTheme.colorScheme.surfaceContainer,
        selectedContentColor: Color = ElyonTheme.colorScheme.onBackground,
