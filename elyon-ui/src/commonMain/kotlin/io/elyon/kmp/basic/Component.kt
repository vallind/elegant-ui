...
/**
 * A basic component with Elyon style. Widely used in other extension components.
 *
...
fun BasicComponent(
    ...
    BasicComponent(
        ...
        if (title != null) {
            Text(
                text = title,
                fontSize = ElyonTheme.textStyles.headline1.fontSize,
...
object BasicComponentDefaults {
    ...
    @Composable
    fun titleColor(
        color: Color = ElyonTheme.colorScheme.onBackground,
    ...
    @Composable
    fun summaryColor(
        color: Color = ElyonTheme.colorScheme.onSurfaceVariantSummary,
        disabledColor: Color = ElyonTheme.colorScheme.disabledOnSecondaryVariant,
    ): BasicComponentColors = remember(color, disabledColor) {
        BasicComponentColors(
            color = color,
