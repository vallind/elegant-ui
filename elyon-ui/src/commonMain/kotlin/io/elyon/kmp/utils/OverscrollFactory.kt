...
/**
 * A Elyon implementation of [OverscrollFactory] that creates [OverscrollEffect] instances
 ...
 * [io.elyon.kmp.theme.ElyonTheme] to automatically apply the Elyon overscroll
 * effect to all Compose scrollable components.
 */
object ElyonOverscrollFactory : OverscrollFactory {
    override fun createOverscrollEffect(): OverscrollEffect = ElyonOverscrollEffect()
...
/**
 * A Elyon [OverscrollEffect] implementing spring-based overscroll physics identical to
 ...
 */
class ElyonOverscrollEffect : OverscrollEffect {
    ...
    // Injected by ElyonOverscrollEffectNode when attached
    ...
    override val node: DelegatableNode = ElyonOverscrollEffectNode(this)
...
private class ElyonOverscrollEffectNode(
    val effect: ElyonOverscrollEffect,
) : Modifier.Node(),
