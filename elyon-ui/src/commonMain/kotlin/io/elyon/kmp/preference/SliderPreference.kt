...
import io.elyon.kmp.basic.SliderColors
                ...
                Row(
                    ...
                    if (valueText != null) {
                        Text(
                            ...
                            color = if (enabled) ElyonTheme.colorScheme.onSurfaceVariantActions else ElyonTheme.colorScheme.disabledOnSecondaryVariant,
                        )
                    }
