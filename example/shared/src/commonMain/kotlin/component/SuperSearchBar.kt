        ...
        Row(
            ...
            if (!searchStatus.isCollapsed()) {
                val capsuleColor = collapsedCapsuleColor?.let {
                    lerp(it, ElyonTheme.colorScheme.surfaceContainerHigh, surfaceAlpha)
                } ?: ElyonTheme.colorScheme.surfaceContainerHigh
                Box(
                    modifier = Modifier
                        .weight(1f)
                        .then(
        ...
        trailingIcon = {
            AnimatedVisibility(
                ...
                Icon(
                    ...
                    tint = ElyonTheme.colorScheme.onSurface,
...
fun SearchBarFake(
    ...
    InputField(
        ...
        modifier = Modifier
            ...
            .padding(bottom = 6.dp)
            .topInset(searchBarTopPadding),
        color = capsuleColor ?: ElyonTheme.colorScheme.surfaceContainerHigh,
        onSearch = { },
        enabled = false,
        expanded = false,
        onExpandedChange = { },
