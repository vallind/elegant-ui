...
import io.elyon.kmp.basic.VerticalDivider
...
private fun OverlayDialogDemo(
    ...
    OverlayDialog(
        show = show,
        title = "Dialog (O)",
        summary = "A dialog component inside ElyonPopupHost.",
...
private fun WindowDialogDemo(
    ...
    WindowDialog(
        show = show,
        title = "Dialog (W)",
        summary = "A window-level dialog, no ElyonPopupHost required.",
        onDismissRequest = onDismissRequest,
        onDismissFinished = onDismissFinished,
        content = {
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    ...
                    text = "Wide Dialog",
                    style = ElyonTheme.textStyles.title4,
                ...
                Text(
                    ...
                    color = ElyonTheme.colorScheme.onSurfaceSecondary,
                    textAlign = TextAlign.Center,
                )
            }
