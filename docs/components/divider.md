...
`Divider` is a basic layout component in Elyon used to separate content in lists and layouts. It provides both horizontal and vertical divider styles.
...
```kotlin
import io.elyon.kmp.basic.HorizontalDivider // Horizontal divider
import io.elyon.kmp.basic.VerticalDivider   // Vertical divider
```
...
| DividerColor  | Color | Default color of divider     | ElyonTheme.colorScheme.dividerLine |
