...
`Switch` is a basic toggle component in Elyon used to switch between two states. It provides an interactive switch control with animation effects, suitable for enabling and disabling settings.
