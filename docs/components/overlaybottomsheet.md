...
`OverlayBottomSheet` is a bottom sheet component in Elyon that slides up from the bottom of the screen. Supports swipe-to-dismiss gestures and custom styling.
...
Scaffold {
    ...
    OverlayBottomSheet(
        show = showBottomSheet,
        title = "Custom Style",
        backgroundColor = ElyonTheme.colorScheme.surfaceVariant,
        dragHandleColor = ElyonTheme.colorScheme.primary,
