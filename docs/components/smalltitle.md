...
`SmallTitle` is a basic title component in Elyon used to create small-sized title text. It follows Elyon's design style with preset font size, weight, and padding.
...
| textColor     | Color         | Title text color              | ElyonTheme.colorScheme.onBackgroundVariant | No       |
