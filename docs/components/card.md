...
`Card` is a basic container component in Elyon, used to hold related content and actions. It provides a card container with Elyon style, suitable for scenarios such as information display and content grouping. Supports both static display and interactive modes.
...
import io.elyon.kmp.utils.PressFeedbackType // If using interactive card
```
