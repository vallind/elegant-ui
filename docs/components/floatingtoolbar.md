...
`FloatingToolbar` is a floating toolbar component in Elyon that renders its content within a container with a rounded background, arranged either horizontally or vertically. The actual placement on the screen is handled by the parent component, typically `Scaffold`.
...
import io.elyon.kmp.basic.ToolbarPosition // Used for Scaffold
```
        ...
        FloatingToolbar {
            Row(
                ...
                IconButton(onClick = { /* Action 1 */ }) {
                    Icon(ElyonIcons.Edit, contentDescription = "Edit")
                }
                IconButton(onClick = { /* Action 2 */ }) {
                    Icon(ElyonIcons.Delete, contentDescription = "Delete")
                }
            }
        }
    },
...
| defaultColor() | @Composable () -> Color | Default background color | ElyonTheme.colorScheme.surfaceContainer |
...
```kotlin
FloatingToolbar(
    color = ElyonTheme.colorScheme.primaryContainer,
    cornerRadius = 16.dp,
    ...
    Row(
        ...
        IconButton(onClick = { /* Action 1 */ }) {
            Icon(ElyonIcons.Edit, contentDescription = "Edit", tint = ElyonTheme.colorScheme.onPrimaryContainer)
        }
        IconButton(onClick = { /* Action 2 */ }) {
            Icon(ElyonIcons.Delete, contentDescription = "Delete", tint = ElyonTheme.colorScheme.onPrimaryContainer)
        }
    }
}
```
