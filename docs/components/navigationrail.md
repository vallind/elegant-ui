...
`NavigationRail` is a side navigation component in Elyon, suitable for wide screens. It displays items as icon-above-label and can optionally expand to a wide icon-beside-label layout via `NavigationRailState`.
...
| color                      | Color                                  | Background color of the rail                  | ElyonTheme.colorScheme.surface    | No       |
