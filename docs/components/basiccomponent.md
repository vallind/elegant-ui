...
`BasicComponent` is a foundational standard component in Elyon. It provides customizable content areas on the start and end sides, along with a title and summary, making it suitable for building list items, settings items, and other UI elements.
