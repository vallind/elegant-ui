...
`TabRow` is a navigation component in Elyon used to create horizontally scrollable tabs. It provides two variants: standard style and contour style, suitable for content categorization and navigation scenarios.
...
```kotlin
import io.elyon.kmp.basic.TabRow // Standard style
import io.elyon.kmp.basic.TabRowWithContour // Contour style
```
...
TabRow(
    ...
    colors = TabRowDefaults.tabRowColors(
        ...
        selectedBackgroundColor = ElyonTheme.colorScheme.primary,
