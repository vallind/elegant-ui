...
`Surface` is a foundational container component in Elyon, used to provide consistent background and border effects for application content, offering a unified visual foundation for interface elements. It supports simple custom styles.
...
Surface(
    modifier = Modifier
        .size(200.dp)
        .padding(16.dp),
    color = ElyonTheme.colorScheme.background,
...
| color           | Color                  | Background color of Surface                      | ElyonTheme.colorScheme.surface    | No       |
| contentColor    | Color                  | Content color of Surface                         | ElyonTheme.colorScheme.onSurface  | No       |
...
Surface(
    ...
    border = BorderStroke(2.dp, ElyonTheme.colorScheme.secondary),
...
Surface(
    ...
    border = BorderStroke(1.dp, ElyonTheme.colorScheme.outline.copy(alpha = 0.2f)),
    shadowElevation = 4.dp
) {
    Column(
        modifier = Modifier.padding(16.dp)
...
Surface(
    ...
    modifier = Modifier.size(200.dp).padding(16.dp),
    shape = RoundedCornerShape(16.dp),
    color = ElyonTheme.colorScheme.surface.copy(alpha = 0.6f),
