...
`ProgressIndicator` is a progress indication component in Elyon used to display the progress status of operations. It provides three styles: linear progress bar, circular progress indicator, and infinite spinning indicator, suitable for different loading and progress display scenarios.
...
```kotlin
import io.elyon.kmp.basic.LinearProgressIndicator // Linear progress bar
import io.elyon.kmp.basic.CircularProgressIndicator // Circular progress indicator
import io.elyon.kmp.basic.InfiniteProgressIndicator // Infinite spinning indicator
```
