...
`NavigationBar` is a bottom navigation bar component in Elyon, used to create navigation menus fixed at the bottom of applications. It supports 2 to 5 navigation items, offering different display modes (icon only, icon and text, icon with selected label).
...
val icons = listOf(ElyonIcons.VerticalSplit, ElyonIcons.Contacts, ElyonIcons.Settings)
...
| color                      | Color                    | Background color of the nav bar     | ElyonTheme.colorScheme.surface        | No       |
...
| -------------------------- | ------------------------ | --------------------------------------- | --------------------------------------- | -------- |
| modifier                   | Modifier                 | Modifier applied to the nav bar         | Modifier                                | No       |
| color                      | Color                    | Background color of the nav bar         | ElyonTheme.colorScheme.surfaceContainer | No       |
