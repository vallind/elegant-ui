...
`Text` component is a basic text component in Elyon, used to display text content. It supports customizing various text styles, alignment, and decoration effects.
...
Elyon provides multiple predefined text styles:
...
| style          | TextStyle      | Text style                              | ElyonTheme.textStyles.main | No       |
...
Text(
    buildAnnotatedString {
        withStyle(style = SpanStyle(color = ElyonTheme.colorScheme.primary)) {
            append("Elyon ")
        }
...
Text(
    ...
    color = {
        lerp(
            ElyonTheme.colorScheme.onSurface,
            ElyonTheme.colorScheme.primary,
    ...
    addLink(
        LinkAnnotation.Url(
            ...
            styles = TextLinkStyles(
                SpanStyle(color = ElyonTheme.colorScheme.primary, fontWeight = FontWeight.Bold)
            )
        ),
        start = start,
        end = length
