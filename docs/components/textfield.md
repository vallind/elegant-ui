...
`TextField` is a basic input component in Elyon for receiving text input from users. The component provides rich customization options, supporting label animations, leading and trailing icons, and other features.
...
| textStyle             | TextStyle                                    | Text style                          | ElyonTheme.textStyles.main                       | No       |
...
Builds a [TextFieldColors] instance. Override any subset; unspecified params fall back to the Elyon theme defaults.

| Parameter        | Type  | Default                                          |
| ---------------- | ----- | ------------------------------------------------ |
| backgroundColor  | Color | ElyonTheme.colorScheme.secondaryContainer        |
| labelColor       | Color | ElyonTheme.colorScheme.onSecondaryContainer      |
| borderColor      | Color | ElyonTheme.colorScheme.primary                   |
...
TextField(
    ...
    trailingIcon = {
        IconButton(
            ...
            Icon(
                imageVector = ElyonIcons.Rename,
                tint = if (passwordVisible) ElyonTheme.colorScheme.primary else ElyonTheme.colorScheme.onSecondaryContainer,
...
Column {
    TextField(
        ...
        colors = TextFieldDefaults.textFieldColors(
            labelColor = if (isError) errorColor else ElyonTheme.colorScheme.onSecondaryContainer,
        ),
...
TextField(
    ...
    cornerRadius = 8.dp,
    colors = TextFieldDefaults.textFieldColors(
        backgroundColor = ElyonTheme.colorScheme.primary.copy(alpha = 0.1f),
    ),
    textStyle = TextStyle(
