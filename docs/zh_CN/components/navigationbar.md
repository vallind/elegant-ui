...
`NavigationBar` 是 Elyon 中的底部导航栏组件，用于在应用底部创建导航菜单，支持 2 到 5 个导航项，提供不同的显示模式（仅图标、图标和文本、仅选中项显示文本）。
...
| color                      | Color                   | 导航栏背景颜色             | ElyonTheme.colorScheme.surface        | 否       |
...
| -------------------------- | ------------------------- | ---------------------------------- | --------------------------------------- | -------- |
| modifier                   | Modifier                  | 应用于导航栏的修饰符               | Modifier                                | 否       |
| color                      | Color                     | 导航栏背景颜色                     | ElyonTheme.colorScheme.surfaceContainer | 否       |
