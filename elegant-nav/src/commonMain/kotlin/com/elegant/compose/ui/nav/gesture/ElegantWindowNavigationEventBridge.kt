 ...
 *     ElegantWindowNavigationEventBridge()
 *     SheetContent()
 * }
 * ```
 *
 ...
 * dispatcher there. Elegant Window* components already do this and do not need the bridge. On Skiko
 * platforms this is a no-op because dialogs share the host window.
 */
@Composable
expect fun ElegantWindowNavigationEventBridge()
