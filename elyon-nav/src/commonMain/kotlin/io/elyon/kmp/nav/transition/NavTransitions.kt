...
package io.elyon.kmp.nav.transition
...
object NavTransitions {
    ...
    /**
     * Default preset. Reproduces the established elyon navigation feel: the entering page slides
     ...
     */
    val ElyonDefault: NavTransition = navGraphicsTransition(opaqueDepth = 1f) { scope ->
