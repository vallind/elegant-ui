 ...
 * duration.
 *
 * This reproduces, point for point, the established enter/exit curve of elyon navigation, so
 ...
 * `NavAnimationEasing` constant the nav3-based elyon navigation ships. The default
 * `NavMotion.programmatic` curve; public so transition presets can reuse the established curve
 * in custom [io.elyon.kmp.nav.transition.NavSettleSpec.Tween]s.
 */
