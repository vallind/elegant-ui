 ...
 *   [io.elyon.kmp.nav.runtime.navBackCompletionDecision], and settles with the single
 *   shared spring via [io.elyon.kmp.nav.runtime.settleTo], handing off the release
