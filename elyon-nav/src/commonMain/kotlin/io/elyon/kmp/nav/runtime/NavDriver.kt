 ...
 * ([io.elyon.kmp.nav.transition.NavMotion]); no other phase redefines these constants.
 */
internal object NavDriverSpec {
     ...
     * (`t ≈ -ln(threshold) / (damping·√stiffness)`), matching the established elyon navigation
