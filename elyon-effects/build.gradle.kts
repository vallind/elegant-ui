    ...
    fun bake() {
        ...
        val source =
            buildString {
                ...
                appendLine()
                appendLine("// Auto-generated by :elyon-effects:bakeSquircleSdf -- do not edit.")
                appendLine()
...
val bakeSquircleSdf by tasks.registering(BakeSquircleSdfTask::class) {
    ...
    packageName.set("io.elyon.kmp.squircle.internal")
...
kotlin {
    ...
    android {
        ...
        namespace = "${BuildConfig.LIBRARY_ID}.effects"
    }
