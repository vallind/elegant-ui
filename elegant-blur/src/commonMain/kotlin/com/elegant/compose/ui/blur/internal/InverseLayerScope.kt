...
/**
 * A [GraphicsLayerScope] implementation that captures layer transform parameters
 * and applies their inverse to a [DrawTransform], enabling correct backdrop
 * positioning when the content layer has been scaled/rotated.
 */
