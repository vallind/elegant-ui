 ...
 */
@Immutable
data class ElegantProgressiveBlur(
    val angle: Float = 90f,
    ...
    companion object {
        ...
        val Top: ElegantProgressiveBlur = ElegantProgressiveBlur(angle = 90f, startFraction = 0f, endFraction = 1f)

        /** Blur strongest at the bottom edge, fading to clear at the top. */
        val Bottom: ElegantProgressiveBlur = ElegantProgressiveBlur(angle = 270f, startFraction = 0f, endFraction = 1f)

        /** Blur strongest at the left edge, fading to clear at the right. */
        val Left: ElegantProgressiveBlur = ElegantProgressiveBlur(angle = 0f, startFraction = 0f, endFraction = 1f)

        /** Blur strongest at the right edge, fading to clear at the left. */
        val Right: ElegantProgressiveBlur = ElegantProgressiveBlur(angle = 180f, startFraction = 0f, endFraction = 1f)
    }
}
